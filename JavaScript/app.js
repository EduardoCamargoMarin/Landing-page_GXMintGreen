...
//servico 01
let list01 = document.getElementById('lists1')

function showServico01() {
    if (list01 ===1) {
        document.getElementById('servico01').innerHTML = ''
        document.getElementById('servico01').style.borderBottom = 'none'
        return list01 = 0
...
//servico 02
let list02 = document.getElementById('lists2')

function showServico02() {
    if (list02 ===1) {
        document.getElementById('servico02').innerHTML = ''
        document.getElementById('servico02').style.borderBottom = 'none'
        return list02 = 0
...
//servico 03
let list03 = document.getElementById('lists3')

function showServico03() {
    if (list03 ===1) {
        document.getElementById('servico03').innerHTML = ''
        document.getElementById('servico03').style.borderBottom = 'none'
        return list03 = 0
...
//servico 04
let list04 = document.getElementById('lists4')

function showServico04() {
    if (list04 ===1) {
        document.getElementById('servico04').innerHTML = ''
        document.getElementById('servico04').style.borderBottom = 'none'
        return list04 = 0
